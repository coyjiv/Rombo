    ...
    <div className="w-full p-4 mt-12 rounded-lg bg-medium-purple shadow-2xl">
      <div className="flex justify-between p-4">
        <button
          ...
          className="text-white p-[6px]  text-3xl rounded-full transition ease-in-out bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-600 duration-300"
        >
          <BiArrowBack />
        </button>
        {!isEditing ? (
          ...
          <ul className="grid gap-4 p-4 text-white">
            ...
            <div className="hover:bg-opacity-60 duration-300 rounded-lg p-4">
              <li className="font-bold flex justify-center">
                <button  onClick={handleEditProfileClick} className="btn btn-primary w-1/3">Edit profile</button>
              </li>
            </div>
          </ul>
        </div>
